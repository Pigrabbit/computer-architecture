...
//  hazard.io := DontCare
  ...
  alu_inputx := MuxCase(0.U, Array(
    (id_ex.excontrol.alusrc1 === 0.U) -> forwarding_inputx,
  ...
  mem_wb.wbcontrol.valid := true.B
  mem_wb.wbcontrol.flush := false.B
